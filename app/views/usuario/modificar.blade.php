...
<div>
    ...
    <div class="form-group">
        {{ Form::label('parentesco', 'Parentesco', array('class' => 'col-sm-2 col-sm-2-10 control_form_label')) }}
        <div class="col-sm-10 col-sm-10-30">
    ...
    <div class="form-group">
        {{ Form::label('perfil', 'Perfil', array('class' => 'col-sm-2 col-sm-2-10 control_form_label')) }}
        <div class="col-sm-10 col-sm-10-30">
            {{ Form::select('perfil',
                array(''=>'Seleccione...',
        ...
        {{ Form::label('user', 'Usuario', array('class' => 'col-sm-2 col-sm-2-10 control_form_label')) }}
        <div class="col-sm-10 col-sm-10-30">
    ...
    <div class="form-group">
        {{ Form::label('password', 'Contrase&ntilde;a', array('class' => 'col-sm-2 col-sm-2-10 control_form_label')) }}
        <div class="col-sm-10 col-sm-10-30">
