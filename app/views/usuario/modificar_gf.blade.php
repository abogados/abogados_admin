...
<div>
    ...
    <div class="form-group">
        {{ Form::label('gf[0][parentesco]', 'Parentesco', array('class' => 'col-sm-2 control-label')) }}
        <div class="col-sm-10">
    ...
    <div class="form-group">
        {{ Form::label('gf[0][nombre]', 'Nombre', array('class' => 'col-sm-2 control-label')) }}
        <div class="col-sm-10">
    ...
    <div class="form-group">
        {{ Form::label('gf[0][apellido]', 'Apellido', array('class' => 'col-sm-2 control-label')) }}
        <div class="col-sm-10">
    ...
    <div class="form-group">
        {{ Form::label('gf[0][dni]', 'DNI', array('class' => 'col-sm-2 control-label')) }}
        <div class="col-sm-10">
    ...
    <div class="form-group">
        {{ Form::label('gf[1][parentesco]', 'Parentesco', array('class' => 'col-sm-2 control-label')) }}
        <div class="col-sm-10">
    ...
    <div class="form-group">
        {{ Form::label('gf[1][nombre]', 'Nombre', array('class' => 'col-sm-2 control-label')) }}
        <div class="col-sm-10">
    ...
    <div class="form-group">
        {{ Form::label('gf[1][apellido]', 'Apellido', array('class' => 'col-sm-2 control-label')) }}
        <div class="col-sm-10">
    ...
    <div class="form-group">
        {{ Form::label('gf[1][dni]', 'DNI', array('class' => 'col-sm-2 control-label')) }}
        <div class="col-sm-10">
    ...
    <div class="form-group">
        {{ Form::label('gf[2][parentesco]', 'Parentesco', array('class' => 'col-sm-2 control-label')) }}
        <div class="col-sm-10">
    ...
    <div class="form-group">
        {{ Form::label('gf[2][nombre]', 'Nombre', array('class' => 'col-sm-2 control-label')) }}
        <div class="col-sm-10">
    ...
    <div class="form-group">
        {{ Form::label('gf[2][apellido]', 'Apellido', array('class' => 'col-sm-2 control-label')) }}
        <div class="col-sm-10">
    ...
    <div class="form-group">
        {{ Form::label('gf[2][dni]', 'DNI', array('class' => 'col-sm-2 control-label')) }}
        <div class="col-sm-10">
