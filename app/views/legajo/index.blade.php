...
<html lang="en">
 <head>
    ...
    {{ HTML::script('packages/jquery/jquery-2.1.1.js')}}
 </head>
 <body>
    <div class="container">
       ...
       <div class="row">
          <div class="col-lg-4">
             {{ Form::open(array('url' => 'legajo/buscar', 'class' => 'form-horizontal', 'role' => 'form', 'id' => 'formulario_busqueda', 'onsubmit' => 'return false')) }}
