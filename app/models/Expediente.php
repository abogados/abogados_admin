...
class Expediente extends Eloquent implements UserInterface, RemindableInterface {
	...
	protected $fillable = array('numero','caratula','juzgado',
      'estado','fecha_inicio','fecha_presentacion','fecha_finalizacion',
      'tipo_proceso','pagos','cliente_id');
